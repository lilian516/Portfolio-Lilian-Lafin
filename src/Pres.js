    ...
    return (
      <div  className='m-4'>
        ...
        <p className=" m-4 mb-8 font-body">En tant que développeur, j'ai toujours voulu comprendre comment fonctionnaient les applications, les jeux vidéo et les logiciels que j'utilisais au quotidien.
          ...
          <a href="/Lilian Lafin - CV.pdf" download="Lilian Lafin - CV.pdf" className=' font-bold rounded-full p-4 bg-blue-500 text-white hover:bg-black transition duration-300 font-body'>Télécharger mon CV</a>
